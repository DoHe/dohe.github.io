...
/** @type {string} */
const CACHE_VERSION = '1728227472|46878894';
/** @type {string} */
const CACHE_PREFIX = 'Drachenkamel-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'alpaca.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["alpaca.html","alpaca.js","alpaca.offline.html","alpaca.icon.png","alpaca.apple-touch-icon.png","alpaca.worker.js","alpaca.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["alpaca.wasm","alpaca.pck"];
